...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    public void onBindViewHolder(StockViewHolder holder, int position) {
        ...
        holder.symbol.setContentDescription(
                context.getString(R.string.content_description_generated_symbol) +
                        holder.symbol.getText() );
        holder.price.setText(dollarFormat.format(cursor.getFloat(Contract.Quote.POSITION_PRICE)));
        holder.price.setContentDescription(
                context.getString(R.string.content_description_generated_price) ); //
        ...
        holder.change.setContentDescription(
                context.getString(R.string.content_description_generated_price_change));
